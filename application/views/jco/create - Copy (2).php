          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="orderno" name="sku" placeholder="Enter Order No" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="Cost price">Batch No</label>
                  <input type="text" class="form-control" id="batchno" name="cost_price" placeholder="Enter Batch No" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  <label for="qty">QC for Loading</label>
				...
				<div class="form-group">
                  <label for="qty">QC for Unloading</label>
				...
				<div class="form-group">
                  <label for="qty">Owner</label>
                  <input type="text" class="form-control" id="owner" name="qty" placeholder="Enter Status" autocomplete="off" />
                </div>
