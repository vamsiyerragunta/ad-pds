...
<script type="text/javascript">
	const api_url='http://127.0.0.1:8000/qualitycontrol/';
        fetch(api_url)
        ...
        function appendData(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                td.innerHTML = data[i].em_qcorderno;
                mainContainer.appendChild(td).style.textAlign = "center";
                td = document.createElement("td");
                td.innerHTML = data[i].em_qcbatchno;
                mainContainer.appendChild(td).style.textAlign = "center";				
				td = document.createElement("td");
                td.innerHTML = data[i].em_qcassetno;
                mainContainer.appendChild(td).style.textAlign = "center";
				td = document.createElement("td");
                td.innerHTML = data[i].em_qcassettype;
                mainContainer.appendChild(td).style.textAlign = "center";
				td = document.createElement("td");
                td.innerHTML = data[i].em_qcmnft_dt;
                mainContainer.appendChild(td).style.textAlign = "center";
				td = document.createElement("td");
                td.innerHTML = data[i].em_qcjmname;
                mainContainer.appendChild(td).style.textAlign = "center";
				td = document.createElement("td");
                td.innerHTML = data[i].em_qcstatus;
                mainContainer.appendChild(td).style.textAlign = "center";
				td = document.createElement("td");
                td.innerHTML = data[i].em_qcremark;
                mainContainer.appendChild(td).style.textAlign = "center";
				td = document.createElement("td");
                td.innerHTML = data[i].em_qc_report_path;
                mainContainer.appendChild(td).style.textAlign = "center";
